...
def fraction_to_decimal_answer(numerator: int, denominator: int, student_result: float):
    ...
    is_correct = math.isclose(correct_decimal, student_result, abs_tol=0.01)
    return is_correct, correct_decimal
...
if __name__ == "__main__":
    ...
    while True:
        ...
        is_correct,correct_decimal = fraction_to_decimal_answer(numerator, denominator, ans_val)
